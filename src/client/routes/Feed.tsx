...
function Feed() {
    ...
    return (
        <>
            ...
            {/* FILTER PANEL */}
            {showFilters && (
                <div className="light-green-tile-bg px-4 py-2.5">
                    <div className="flex gap-6 items-start max-w-[900px] mx-auto">
                        {/* Weather Filters */}
                        <div className="flex-1 bg-white border-2 border-black p-2.5">
                            <div className="flex items-center gap-1.5 mb-2 pb-1.5 border-b-2 border-[#0039A6]">
                                <div className="w-5 h-5 rounded-full bg-[#0039A6] flex items-center justify-center text-white text-[0.6rem]">☀</div>
                                <div className="text-[0.65rem] font-['ArchivoNarrow'] font-black tracking-widest text-[#0039A6]">WEATHER</div>
                            </div>
                            <div className="flex flex-wrap gap-1">
                                {['sunny', 'cloudy', 'rainy', 'snowy', 'windy', 'foggy', 'humid', 'crisp'].map(tag => (
                                    <button
                                        ...
                                        className={`px-2 py-1 text-[0.65rem] font-['ArchivoNarrow'] font-bold uppercase border-2 transition-all hover:scale-105 ${
                                            selectedWeatherFilter === tag
                                                ? 'bg-[#ff6319] text-white border-black shadow-[1px_1px_0px_0px_rgba(0,0,0,1)]'
                        ...
                        <div className="flex-1 bg-white border-2 border-black p-2.5">
                            <div className="flex items-center gap-1.5 mb-2 pb-1.5 border-b-2 border-[#0039A6]">
                                <div className="w-5 h-5 rounded-full bg-[#0039A6] flex items-center justify-center text-white text-[0.6rem]">😊</div>
                                <div className="text-[0.65rem] font-['ArchivoNarrow'] font-black tracking-widest text-[#0039A6]">MOOD</div>
                            </div>
                            <div className="flex flex-wrap gap-1">
                                    ...
                                    <button
                                        ...
                                        className={`px-2 py-1 text-[0.65rem] font-['ArchivoNarrow'] font-bold uppercase border-2 transition-all hover:scale-105 ${
                                            selectedMoodFilter === tag
                                                ? 'bg-[#ffd54f] text-black border-black shadow-[1px_1px_0px_0px_rgba(0,0,0,1)]'
            ...
            <div className="light-green-tile-bg h-[2%]"></div>
            <div className={`tile-bg ${showFilters ? 'h-[78%]' : 'h-[82%]'} flex items-center justify-center overflow-hidden relative pt-8`}>
                {loading ? (
                    /* LOADING STATE */
